...
import { getProfessionalById, getUsersById, putEditAppointment, selectedTime, deleteAppointment } from '../../Redux-actions';
import ModalPayment from '../Home/ModalPayment';
import ModalErrors from '../ModalsErrors/ErrorsRouta';

export default function ModalCalendar({isProfesional, info, professionalMedicalLicense,adId,name, ad}) {
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Title>Usted se atendera con:
