 ...
 */
  ...
  if(Array.isArray(morningHours)){
    hours= morningHours.map(hr=>{return hr.start })
    ...
    <>
      ...
      <div>
        ...
        <div className="conteinerDate">
          ...
          <button className="button" onClick={submitTimeRange}>
          ...
          <button className="button" onClick={newTimeRange}>
            Seleccione otro rango horario para el mismo dia
          </button>
          ...
          {timeRanges ? (
            <>
              ...
              <button className="button" onClick={submitTimeRange2}>
                Confirme rango horario
              </button>
              {Array.isArray(afternoonHours) ? (
                afternoonHours.map((h, i) => (
                  <div className="li">
                    <p key={i}>{h.start};</p>
                  </div>
                ))
                ...
                <div className="li">
                  <p className="li">{afternoonHours.start};</p>
                </div>
              )}
            </>
          ) : null}

          <button className="button" onClick={(e) => submitAll(e)}>
            Confirma tus turnos
          </button>
        </div>
        {/* <Footer/> */}
