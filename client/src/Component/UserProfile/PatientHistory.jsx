...
import { clearUserAppointments, getProfessionalApps, traemeTodo, clearTodo, modalProfessionalApps, modalMedicalRecord } from "../../Redux-actions/index.js";
...
export default function PatientHistory({ medicalLicense }) {
  ...
  {
    field: 'Ver Historia Clinica', renderCell: renderDetailsButton, width: 200,
    disableClickEventBubbling: true
  }]


  let pendingAppointments = professionalApps.appointments?.filter((e) => e.status === 'completed')
